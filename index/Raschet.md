...
4. 
5. Неточности в сотые доли процента являются, скорее всего, результатами моего округления до четвертого – пятого – шестого десятичного знака после запятой в процессе вычислений. Это можно легко избежать предельно повысив точность вычислений.
6. 
